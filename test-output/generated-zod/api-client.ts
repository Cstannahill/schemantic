...
export class ImageManipulationApiClient {
  ...
  async healthCheckHealthGet(options?: RequestInit): Promise<HealthResponse> {
    ...
    return this.request<HealthResponse>(url.toString(), requestOptions);
  }

  async convertImageConvertPost(body: BodyConvertImageConvertPost | FormData, options?: RequestInit): Promise<unknown | void | void | void> {
    const url = new URL(`${this.baseUrl}${this.buildPath(`/convert/`, {})}`);
    ...
    return this.request<unknown | void | void | void>(url.toString(), requestOptions);
  }

  async batchConvertImagesConvertBatchPost(body: BodyBatchConvertImagesConvertBatchPost | FormData, options?: RequestInit): Promise<unknown | void | void | HTTPValidationError> {
    const url = new URL(`${this.baseUrl}${this.buildPath(`/convert/batch`, {})}`);
    ...
    return this.request<unknown | void | void | HTTPValidationError>(url.toString(), requestOptions);
  }

  async listFormatsConvertFormatsGet(options?: RequestInit): Promise<Record<string, unknown>> {
    const url = new URL(`${this.baseUrl}${this.buildPath(`/convert/formats`, {})}`);
    ...
    return this.request<Record<string, unknown>>(url.toString(), requestOptions);
  }
  ...
  async rootGet(options?: RequestInit): Promise<unknown> {
    ...
    return this.request<unknown>(url.toString(), requestOptions);
  }
